...
a = pd.read_csv("reproducing_results/data/repr_4.csv", index_col = 0, delimiter = ";")
print(a)
...
# plt.savefig("reproducing_results/reproduced_graphs/theta_comp_log_4.png")
...
plt.savefig("reproducing_results/reproduced_graphs/order_comparison_4.png")
